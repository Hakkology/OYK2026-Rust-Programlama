// Gun 2 / Ders 4 - Borrowing Kurallari
// rustc main.rs && ./main
...
fn main() {
    ...
    // ayni kod, sira degisince derleniyor
    ...
    let iyi = sarkan_degil();
    println!("{}", iyi);

    // veri yarisi icin uc kosul gerekir; Rust ucuncusunu keser
    ...
    // dizi elemanini mutable odunc almak diziyi kilitler
    let mut d = [1, 2, 3];
    let e = &mut d[0];
    *e = 10;
